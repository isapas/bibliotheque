 ...
 */
final class Version20190208140649 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books ADD users_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books DROP users_id, CHANGE category_id category_id INT NOT NULL');
